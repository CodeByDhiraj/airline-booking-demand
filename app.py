...
def insights():
    ...
    if not summary:
        return render_template("insights.html", ai_insight="No data available for insights. Please fetch some flights first.")
    ...
    try:
        ...
        prompt = (
            "You are an expert in airline market analysis. Based on the following flight statistics (routes, dates, airlines), provide a concise summary of flight demand trends and passenger travel patterns:\n"
    + summary
            + summary
        )
